...
| 12-15 22:49 | 動画入力時のメトリクス取得不整合を修正し、GUIにPass別トークン/コストを表示 | `src/pipeline/poc.py`, `src/gui/controller.py`, `src/gui/workflow_panel.py`, `docs/requirement.md` |
