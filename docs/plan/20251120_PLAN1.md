...
3. `docs/specs/progress_resume_spec.md` を基に CLI `--resume` 実装に必要な状態遷移/エラー処理を詳細設計し、Phase 3 着手準備を整える
...
- [ ] Phase 3: CLI UX/再開機構/ログ強化（0% / 詳細プラン策定済み）
...
| `scripts/poc_transcribe.py` | 🆕 更新 | BlockSplitter によるブロックJSON保存スタブ | PoCフロー | Phase 1 |
